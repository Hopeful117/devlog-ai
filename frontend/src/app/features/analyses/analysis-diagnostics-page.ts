...
@Component({
  selector: 'app-analysis-diagnostics-page',
  imports: [
    AsyncPipe,
    DatePipe,
    JsonPipe,
  ...
  templateUrl: './analysis-diagnostics-page.html',
  styleUrl: './analysis-diagnostics-page.scss',
})
export class AnalysisDiagnosticsPage {
