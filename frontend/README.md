...
uses a session-local reviewer identity generated by the frontend; an optional note is limited to
2000 characters. Core still records the resulting reviewer identifier for immutable decision
attribution.
...
Current limitations include no bulk review, no proposal or Insight editing, no deletion, and no
authentication.
